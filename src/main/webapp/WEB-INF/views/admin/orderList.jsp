			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.XiongHoubing.model.Order o=(com.XiongHoubing.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.XiongHoubing.dao.UserDao userDao=new com.XiongHoubing.dao.UserDao();
						...
						<%
							...
							String paymentType=com.XiongHoubing.model.Payment.findByPaymentId(con,n);
							 %>
